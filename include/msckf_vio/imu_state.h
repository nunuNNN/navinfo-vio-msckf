...
struct IMUState
{
    ...
    // left camera (cam0)
    Eigen::Matrix3d R_cam0_from_imu;
    Eigen::Vector3d t_imu_from_cam0;
    ...
    // The z axis of the body frame should point upwards. H.K?
    // Normally, this transform should be identity.
    static Eigen::Isometry3d T_body_from_imu;
